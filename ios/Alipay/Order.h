...
//新境外收单必传参数，移动端是NEW_WAP_OVERSEAS_SELLER。
//the parameter for New cross_border payment,mandatory
@property (nonatomic, copy) NSString *product_code;

//商户网站使用的编码格式，固定为utf-8。
//input_charset,should be utf-8
...
@property (nonatomic, copy) NSString *forexbiz;
...
//This parameter is to set the overtime of non-payment transaction. The transaction will be closed automatically once the time is up.
//Range of values: 1m～15d, m-minute, h-hour, d-day, 1c-current day (Whenever the transaction is created, it will be closed at 0:00).
...
//To add other parameters,please refer to development documents.
