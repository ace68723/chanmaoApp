...
export default class SboxCartAlert extends Component {
  constructor() {
    super();
      ...
      return(
        <TouchableOpacity style={{
          ...
          <View style={{padding:20,paddingLeft:25,paddingRight:25,alignItems:'center',justifyContent:'center'}}>
            <Text allowFontScaling={false} style={{fontSize:16,fontFamily:'NotoSans-Regular',textAlign:'left',color:'white'}}>
                {this.props.message}
            </Text>
          </View>
