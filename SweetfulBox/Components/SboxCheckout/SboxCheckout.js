...
//                 <Text style={{fontSize:16,fontFamily:'NotoSans-Regular',}}>{fullname}</Text>
//                 <Text style={{fontSize:16,fontFamily:'NotoSans-Regular',}}>${sku_price} <Text style={{fontSize:16,fontFamily:'NotoSans-Regular', textDecorationLine: 'line-through'}}> ${original_price}</Text></Text>
//               </View>
//               <View style={{flex:0.2}}>
//                 <Text style={{fontSize:16,fontFamily:'NotoSans-Regular',}}>x{selectedAmount}</Text>
//               </View>
//             </View>
