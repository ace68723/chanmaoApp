Index.js:Change all 'if (Platform.OS==='ios')' to 'if (Platform.OS)' 
...
const ScrollableTabView = createReactClass({
  ...
  render() {
    ...
    let tabBarProps = {
      ...
      activeIconImages: this._children().map((child) => child.props.activeIconImage),

      inactiveIconImages: this._children().map((child) => child.props.inactiveIconImage),
    };
