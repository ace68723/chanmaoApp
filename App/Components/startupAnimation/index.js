      ...
      return (
        <Animated.View style={[styles.container,{opacity: this.state.opacity}]}>
          <Image style={{
            ...
            source={isDaytime ? require('./image/启动页-多伦多-白天背景.png') : require('./image/启动页-多伦多-夜晚背景.png')} />
      ...
      return(
        <View style={{
          ...
          <Animated.Image style={{
            ...
            }} source={ isDaytime ? require('./image/sun.png') : require('./image/moon.png')}/>
          <View style={{ 
            position:'absolute',
            top:30 * sizeScale,
            right:20* sizeScale}} >
            <Image style={{height: 70*0.619*sizeScale, width: 70*sizeScale}}  source={isDaytime?require('./image/cloud-day.png') : require('./image/cloud-night.png')} />
          </View>
      ...
      return(
        <Animated.View style={{ 
          ...
          <Image style={{
            ...
            source={this.state.isTopLeftButtonPressed ?require('./image/启动页-施工中-按下.png') : require('./image/启动页-施工中.png')} />
        </Animated.View>
      );
    }
    renderTopLeftButton(){
        ...
        <Animated.View style={{
          ...
          right:-40* sizeScale}}>
            <Image style={{
              ...
              source={this.state.isTopRightButtonPressed ? require('./image/启动页-馋猫订餐-按下.png') : require('./image/启动页-馋猫订餐.png')} />
        </Animated.View>
      );
    }
      ...
      return (
          <Animated.View style={{
            ...
            <Image style={{
                ...
                source={this.state.isBottomLeftButtonPressed ? require('./image/启动页-馋猫电商-按下.png') : require('./image/启动页-馋猫电商.png')} />
          </Animated.View>
      ...
      return (
          <Animated.View style={{
            ...
            <Image style={{
                ...
                source={this.state.isBottomRightButtonPressed ? require('./image/启动页-馋猫生活-按下.png') : require('./image/启动页-馋猫生活.png')} />
          </Animated.View>
      );
    }
